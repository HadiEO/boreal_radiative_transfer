# Modify PARAS function to accept wL --------------------------------------
paras.varymaininput.wL <- function(LAIe, CI, DIFN, i0, cgf.view,                     # Gap fractions data from DHP
                                   wL.b1, wL.b2, wL.b3, wL.b4, wL.b5, wL.b7,            # Now, wL
                                   Rg.b1, Rg.b2, Rg.b3, Rg.b4, Rg.b5, Rg.b7) {          # Ground reflectance   
