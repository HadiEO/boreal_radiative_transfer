...
shp <- readOGR(dsn="data/gis", layer="LAI_2015_utm34N")                           # Careful utm35N for L8, utm34N for S2 image!
...
write.csv2(spc.w12.5, "results/BOA_L8_sq25m_2014_wrongcoords.csv")
